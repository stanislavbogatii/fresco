        ...
        <div className="product__top">
          <div className="product__top-preview">
            <div className="product__top-active-image">
              <Image
                key={slides[activeIndex].src.src}
          ...
          <div className="product__top-content">
            <h1 className="product__top-title">Ciabatta fully baked</h1>
            <span className="product__article">COD: LLR229</span>
            <span className="product__top-weight">60g</span>
            <StarRating />
            <p className="product__top-descr">
              Ciabatta clasica este gata coapta, are miez aerat si coaja subtire.
              Poate fi consumata imediat dupa decongelare.
            </p>
